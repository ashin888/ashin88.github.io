...
echo" <form action='' method='get' accept-charset='utf-8'>
         ...
         <center>
           <input type='text' class='num' name='mo' id='numb' placeholder='Enter Unregistered Number' required>
         </center>
         <center>
           <input type='text' class='refer' name='refer' id='ref' placeholder='Enter Refer Code' required>
         </center>
         <center>
           <input type='submit' class='sub' name='submit' id='submit' value='SEND OTP'>
         </center>
        </form>";
...
curl_close($ch);
  ...
  echo "<form action='otp.php' method='get' accept-charset='utf-8'>
          <input type='hidden' name='mo' value='$mo'>
          <input type='hidden' name='refer' value='$refer'>
          <input type='hidden' name='otp' value='$otp'>
         <center>
           <input type='text' class='otp' name='otp' id='numb' placeholder='Enter Your OTP' required>
         </center>
